...
\begin{tabular}{|p{3.5cm}|p{10.5cm}|}
    \hline
    \textbf{In the context of} & designing an intuitive and engaging user interface for the TrIP system terminals \\
    \hline
    \textbf{Facing} & the challenge of selecting guiding principles and frameworks that will shape the user experience and interaction design \\
    \hline
    ...
    \hline
    \textbf{Accepting} & This decision will impact the development timeline, operational costs, and the user's ability to navigate the system effectively \\
    \hline
\end{tabular}
