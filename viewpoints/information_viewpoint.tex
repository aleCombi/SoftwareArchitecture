...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|c|c|}
      ...
      Information View & 
       & % Usability
      \cellcolor{gray!60}X & % Performance (2nd priority)
...
\begin{table}[H]
    ...
    Accounts/Subs DB & Maintains records of passenger accounts and their subscriptions for travel services. \\
    ...
    Accounts (Subs) & Manages the subscription details associated with passenger accounts. \\
